...
_NUMPY_EXPERIMENTAL_ARRAY_FUNCTION_AUTOENABLE = False
_NUMPY_EXPERIMENTAL_ARRAY_FUNCTION = os.environ.get("NUMPY_EXPERIMENTAL_ARRAY_FUNCTION")
if _NUMPY_EXPERIMENTAL_ARRAY_FUNCTION is not None:
    _NUMPY_EXPERIMENTAL_ARRAY_FUNCTION = str(_NUMPY_EXPERIMENTAL_ARRAY_FUNCTION).strip()
    if _NUMPY_EXPERIMENTAL_ARRAY_FUNCTION_AUTOENABLE and _NUMPY_EXPERIMENTAL_ARRAY_FUNCTION == "0":
        if _INFO_PRINT_ENABLE:
            print('info: auto enabling NUMPY_EXPERIMENTAL_ARRAY_FUNCTION')
        os.environ["NUMPY_EXPERIMENTAL_ARRAY_FUNCTION"] = "1"
