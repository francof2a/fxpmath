...
* Before submitting, it is highly recommended:
  ...
  * Update [CHANGELOG.md](https://github.com/francof2a/fxpmath/blob/master/CHANGELOG.md) at the top using the current sectioned format (`Added`, `Changed`, `Fixed`, `Compatibility`, `Documentation`, `Tests`, or `Notes` as applicable). Link the solved issue where relevant.
...
* Update [CHANGELOG.md](https://github.com/francof2a/fxpmath/blob/master/CHANGELOG.md) at the top using the current sectioned format.
